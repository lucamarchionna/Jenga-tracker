...
int main(int argc, char **argv)
{
  ...
  tracker.loadModel("/home/giulio/catkin_ws/src/tracker_visp/model/jenga_single.cao");  
  //tracker.loadModel("../model/jenga_single.cao");  
  tracker.setDisplayFeatures(true);
  tracker.initClick(I, "/home/giulio/catkin_ws/src/tracker_visp/model/jenga_single.init", true);  
  tracker.track(I);
