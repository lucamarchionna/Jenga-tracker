...
if(tracker_visp_CONFIG_INCLUDED)
  return()
endif()
set(tracker_visp_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("FALSE" STREQUAL "TRUE")
  set(tracker_visp_SOURCE_PREFIX /home/giulio/catkin_ws/src/Jenga-tracker)
  set(tracker_visp_DEVEL_PREFIX /home/giulio/catkin_ws/src/Jenga-tracker/build/devel)
  set(tracker_visp_INSTALL_PREFIX "")
  set(tracker_visp_PREFIX ${tracker_visp_DEVEL_PREFIX})
else()
  set(tracker_visp_SOURCE_PREFIX "")
  set(tracker_visp_DEVEL_PREFIX "")
  set(tracker_visp_INSTALL_PREFIX /usr/local)
  set(tracker_visp_PREFIX ${tracker_visp_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'tracker_visp' is deprecated")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    list(APPEND tracker_visp_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /usr/local/lib;/home/giulio/catkin_ws/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(tracker_visp_LIBRARY_DIRS ${lib_path})
      list(APPEND tracker_visp_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'tracker_visp'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND tracker_visp_LIBRARIES ${lib})
    endif()
  endif()
...
set(tracker_visp_EXPORTED_TARGETS "tracker_visp_generate_messages_cpp;tracker_visp_generate_messages_eus;tracker_visp_generate_messages_lisp;tracker_visp_generate_messages_nodejs;tracker_visp_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${tracker_visp_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "rospy;roscpp;geometry_msgs;std_msgs;pcl_ros;pcl_msgs;pcl_conversions;visp_bridge")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 tracker_visp_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${tracker_visp_dep}_FOUND)
      find_package(${tracker_visp_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${tracker_visp_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(tracker_visp_INCLUDE_DIRS ${${tracker_visp_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(tracker_visp_LIBRARIES ${tracker_visp_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${tracker_visp_dep}_LIBRARIES})
  _list_append_deduplicate(tracker_visp_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(tracker_visp_LIBRARIES ${tracker_visp_LIBRARIES})

  _list_append_unique(tracker_visp_LIBRARY_DIRS ${${tracker_visp_dep}_LIBRARY_DIRS})
  list(APPEND tracker_visp_EXPORTED_TARGETS ${${tracker_visp_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "tracker_visp-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${tracker_visp_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
