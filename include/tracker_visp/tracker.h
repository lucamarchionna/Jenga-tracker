...
class tracking 
{
    ...
    private:
        ...
        bool opt_display_projection_error{false}, opt_display_features{true}, opt_display_model{true}, opt_yolact_init{true}, opt_pose_init{true}, learn_position{true}, rotated{false}, opt_use_depth{false};
